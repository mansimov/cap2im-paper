...
\FIXME{For the MNIST with Captions task, the model was trained for 150 epochs and the 
learning rate was reduced to $0.0001$ after 110 epochs. During each epoch, randomly created $10,000$ training samples were used for training.}
